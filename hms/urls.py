...
urlpatterns = [
    ...
    path('staff-dashboard/vc/', views.vc_dashboard, name='vc_dashboard'),
    path('staff-dashboard/dvc/', views.dvc_dashboard, name='dvc_dashboard'),
    path('staff-dashboard/reg-admin/', views.reg_admin_dashboard, name='reg_admin_dashboard'),
    path('staff-dashboard/reg-user/', views.reg_user_dashboard, name='reg_user_dashboard'),
    path('staff-dashboard/dean-grad/', views.dean_grad_dashboard, name='dean_grad_dashboard'),
    path('staff-dashboard/dir-resource/', views.dir_resource_dashboard, name='dir_resource_dashboard'),
    path('staff-dashboard/news-auditor/', views.news_auditor_dashboard, name='news_auditor_dashboard'),
    path('staff-dashboard/deferment-officer/', views.deferment_officer_dashboard, name='deferment_officer_dashboard'),
    path('staff-dashboard/dept-mcs/', views.dept_mcs_dashboard, name='dept_mcs_dashboard'),
    path('staff-dashboard/health-manager/', views.health_manager_dashboard, name='health_manager_dashboard'),
    path('staff-dashboard/maintenance-supervisor/', views.maintenance_supervisor_dashboard, name='maintenance_supervisor_dashboard'),
    path('staff-dashboard/finance-officer/', views.finance_officer_dashboard, name='finance_officer_dashboard'),
    path('staff-dashboard/news-editor/', views.news_editor_dashboard, name='news_editor_dashboard'),
    path('staff-dashboard/emergency-coordinator/', views.emergency_coordinator_dashboard, name='emergency_coordinator_dashboard'),
    path('staff-dashboard/support-agent/', views.support_agent_dashboard, name='support_agent_dashboard'),
    path('staff-dashboard/auditor/', views.auditor_dashboard, name='auditor_dashboard'),
    path('staff-dashboard/dept-coordinator/', views.dept_coordinator_dashboard, name='dept_coordinator_dashboard'),
    ...
    path('manage/staff/invitation/<int:invite_id>/action/', views.manage_invitation_action, name='manage_invitation_action'),
    path('manage/student/generate-link/', views.generate_student_link, name='generate_student_link'),
    path('manage/student/invitation/<int:invite_id>/action/', views.manage_student_invitation_action, name='manage_student_invitation_action'),
    path('manage/staff/register/manual/', views.manual_register_staff, name='manual_register_staff'),
    path('manage/staff/details/<int:staff_id>/', views.staff_details, name='staff_details'),
    path('manage/roles/', views.manage_roles, name='manage_roles'),
    path('manage/permissions/matrix/', views.permission_matrix, name='permission_matrix'),
    path('manage/permissions/save/', views.save_permissions, name='save_permissions'),
    path('manage/staff/delete/<int:staff_id>/', views.delete_staff, name='delete_staff'),
    path('manage/staff/generate-link/', views.generate_staff_link, name='generate_staff_link'),
    path('manage/staff/invitations/<int:invite_id>/', views.manage_invitation_action, name='manage_invitation_action'),
    ...
    path('alerts/', views.announcements_list, name='alerts_alias'), # Fix for 404
    path('manage/announcements/', views.manage_announcements, name='manage_announcements'),
    path('manage/alerts/', views.manage_announcements, name='manage_alerts_alias'), # Fix for 404
