...
### 3.1 Role-Based Access Control (RBAC) - Core Features
The system restricts access based on the following roles:

| Role | Core Features / Dashboards | Access Level |
| :--- | :--- | :--- |
| **Super Admin** | All Features, Audit Logs, Staff Management | Full System |
| **Welfare Officer** | Deferments, Announcements, Student Info | Welfare Admin |
| **Hostel Manager** | Rooms, Assignments, Maintenance | Hostel Admin |
| **Kitchen Manager** | Meal Counts, Daily Menu, Export CSV | Kitchen Admin |
| **Security** | Visitor Logs, SOS Alerts | Security Admin |
| **TVET Director** | Academic Analytics (TVET specific) | Academic Admin |
| **Health & Staff** | Appointments, Clinical Notes | Specific Modules |
| **Student** | Personal Dashboard, Meal Booking, SOS | Student Portal |
